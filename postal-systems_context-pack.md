...
Goal: Fix audit issues and elevate the Astro + Tailwind site to "25k agency" quality without changing the core brand/theme (no rebrand, no palette overhaul, no new look direction).
...
- Allowed: polish, spacing rhythm, typography hierarchy, component consistency, states (hover/focus/active), refined section composition.
...
- Templates must stay consistent: page structure + UX pattern consistent by type.
...
- 13 cities x 8 services = 104 pages; if content falls back to generic blocks, indexing suffers.
...
- Ensure long-tail pages reachable within <=2 clicks from hubs.
...
- Standardize layout primitives (Section/Container), Card system, Button/Input states.
