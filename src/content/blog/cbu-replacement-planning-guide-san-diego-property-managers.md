---
title: "CBU Replacement Planning Guide for San Diego Property Managers"
...
If you are assessing active issues, review [mailbox replacement and retrofits in San Diego](/service-areas/san-diego/mailbox-replacement-retrofits/) and the broader [mailbox replacement and retrofits service](/services/mailbox-replacement-retrofits/). If your scope may require a new cluster layout, compare options through [CBU installation in San Diego](/service-areas/san-diego/cbu-installation/) and [CBU installation service](/services/cbu-installation/).
...
Property teams comparing nearby retrofit patterns can also review [Carlsbad mailbox replacement and retrofits](/service-areas/carlsbad/mailbox-replacement-retrofits/) and [Vista mailbox replacement and retrofits](/service-areas/vista/mailbox-replacement-retrofits/).
...
**How do we decide between repairing and replacing a CBU?**
Compare the scale of damage, recurrence of service calls, parts availability, and whether security or package capacity needs have changed.

**Can we replace units in phases across a larger property?**
Yes. Many managers phase projects by building cluster, provided communication and temporary access plans are clear.

**What is the biggest planning mistake in CBU replacements?**
Treating key handoff and resident communication as end-of-project tasks instead of core planning items.
